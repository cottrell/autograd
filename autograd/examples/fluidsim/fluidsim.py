...
if __name__ == '__main__':
    ...
    result = minimize(objective_with_grad, init_dx_and_dy, jac=True, method='CG', options={'maxiter': 25, 'disp': True}, callback=callback)
    ...
    os.system('convert -delay 5 -loop 0 step*.png -delay 250 step100.png surprise.gif')

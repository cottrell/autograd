...
def bernoulli_log_density(targets, unnormalized_logprobs):
    ...
    return np.sum(label_probabilities, axis=-1)
...
if __name__ == '__main__':
    ...
    optimized_params = adam(objective_grad, combined_init_params, step_size=step_size, num_iters=num_epochs * num_batches, callback=print_perf)
...
from ..numpy.numpy_wrapper import wrap_namespace
from ..extend import defvjp, defvjp_argnums, defjvp, defjvp_argnums
wrap_namespace(scipy.linalg.__dict__, globals())
...
def grad_solve_triangular(ans, a, b, trans=0, lower=False, **kwargs):
    ...
    return vjp
defvjp(solve_triangular, grad_solve_triangular, lambda ans, a, b, trans=0, lower=False, **kwargs: lambda g: solve_triangular(a, g, trans=_flip(a, trans), lower=lower))
